...
struct custom_mutator {
 ...
 /**
   * Inform the custom mutator about the changes in coverage caused by the last
   * mutation.
   *
   * (Optional)
   *
   * @param[in] coverage_map Pointer to the coverage map associated with the 
   *            last mutated input
   * @param[in] size of coverage_map
   * 
   */
  void (*afl_custom_mutation_feedback)(u8* coverage_map, u32 map_size);
  /**
